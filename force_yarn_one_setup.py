...
f_y= [None]*720
f_z=[None]*720
total_force_x = [None]*(n_count)
total_force_y = [None]*(n_count)
total_force_z = [None]*(n_count)

# total_force_x = [None]*16
# total_force_y = [None]*16
# total_force_z = [None]*16


for point in range(1,n_count):
    ####### set the directory
...
if reed_type == "Reed_8":
    ...
    plt.ylabel('Force/(0.1mm) (mN/m)')
    plt.legend(loc='best')
    pic_name= "Fx_distribution_setup_" + str(i) + "_yarn_speed_" + str(speed) +"_yarn_position_1_5_9.png"
    plt.savefig(pic_name, transparent=False)
    # plt.show()
    plt.close()
    ...
    plt.ylabel('Force/(0.1mm) (mN/m)')
    plt.legend(loc='best')
    pic_name= "Fy_distribution_setup_" + str(i) + "_yarn_speed_" + str(speed) +"_yarn_position_1_5_9.png"
    plt.savefig(pic_name, transparent=False)
    # plt.show()
    plt.close()
    ...
    plt.ylabel('Force/(0.1mm) (mN/m)')
    plt.legend(loc='best')
    pic_name= "Fz_distribution_setup_" + str(i) + "_yarn_speed_" + str(speed) +"_yarn_position_1_5_9.png"
    plt.savefig(pic_name, transparent=False)
    # plt.show()
    plt.close()
